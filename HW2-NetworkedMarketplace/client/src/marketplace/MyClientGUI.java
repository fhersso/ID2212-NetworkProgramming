...
public class MyClientGUI extends JPanel {
    ...
    private Component createConnectPanel() {
        ...
        connectPanel.setPreferredSize(new Dimension(400, 60));
        return connectPanel;
    }
    ...
    private Component createWishSellPanel() {
        ...
        wishSellPanel.setPreferredSize(new Dimension(400, 80));
    ...
    private Component createBuyPanel() {
        ...
        buyPanel.setPreferredSize(new Dimension(400, 100));
        return buyPanel;
    }
    ...
    private Component createMarketPanel() {
        ...
        marketPanel.setPreferredSize(new Dimension(400, 250));
        return marketPanel;
    }
